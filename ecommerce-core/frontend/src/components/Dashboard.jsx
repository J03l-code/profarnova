      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-40 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <span className="h-10 w-10 rounded-lg bg-emerald-500 flex items-center justify-center text-white text-xl font-bold">
              P+
            </span>
            <span className="text-xl font-extrabold text-slate-900 tracking-tight">
              PROFARNOVA <span className="text-emerald-500 font-semibold text-sm bg-emerald-50 px-2 py-1 rounded ml-1 uppercase">Admin</span>
            </span>
          </div>
